...
void cornell_smoke() {
    ...
    shared_ptr<hittable> box1 = quad_box(box(point3(0,0,0), point3(165,330,165)), white); // material does not matter
    box1 = make_shared<rotate_y>(box1, degrees(15));
    box1 = make_shared<translate>(box1, vec3(265,0,295));

    shared_ptr<hittable> box2 = quad_box(box(point3(0,0,0), point3(165,165,165)), white); // material does not matter
    box2 = make_shared<rotate_y>(box2, degrees(-18));
    box2 = make_shared<translate>(box2, vec3(130,0,65));
...
void final_scene(int image_width, int samples_per_pixel, int max_depth) {
    ...
    for (int i = 0; i < boxes_per_side; i++) {
        for (int j = 0; j < boxes_per_side; j++) {
            ...
            boxes1.add(quad_box(box(point3(x0,y0,z0), point3(x1,y1,z1)), ground));
        }
    }
    ...
    world.add(make_shared<translate>(
        make_shared<rotate_y>(make_shared<bvh_node>(boxes2), degrees(15)),
        vec3(-100,270,395)
    ));
